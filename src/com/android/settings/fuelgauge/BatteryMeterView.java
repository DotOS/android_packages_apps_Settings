...
public class BatteryMeterView extends CardView {
    ...
    private void init(Context context) {
        ...
        progress_Text.setText(getBatteryLevel());
        ...
        progress_Text.setText(String.format("%d%%", getBatteryLevel()));
        if (getCharging()) {
            charging_Text.setText("Charging");
        } else
    ...
    class WaveView extends LinearLayout {
        ...
        private int mAboveWaveColor = getColorAttr(BatteryMeterView.this.getContext(), R.attr.colorAccent);
        ...
        public WaveView(Context context) {
            ...
            mWave.setBlowWaveColor(Color.argb(255, Color.red(mAboveWaveColor), Color.green(mAboveWaveColor), Color.blue(mAboveWaveColor)));
