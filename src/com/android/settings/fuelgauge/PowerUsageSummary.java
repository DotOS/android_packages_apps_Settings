...
public class PowerUsageSummary extends PowerUsageBase implements OnLongClickListener,
    ...
    protected void refreshUi(@BatteryUpdateType int refreshType) {
        ...
        mBatteryTemp.setSubtitle(
                com.android.internal.util.dotos.DOTUtils.mccCheck(getContext()) ?
                com.android.internal.util.dotos.DOTUtils.batteryTemperature(getContext(), true) + "°F" :
                com.android.internal.util.dotos.DOTUtils.batteryTemperature(getContext(), false) + "°C");
    }
