...
public class OSInfoDialogFragment extends InstrumentedDialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        LinearLayout model_layout = content.findViewById(R.id.model_layout);
        LinearLayout dot_version_layout = content.findViewById(R.id.dot_version_layout);
        LinearLayout build_date_layout = content.findViewById(R.id.build_date_layout);
        LinearLayout security_patch_layout = content.findViewById(R.id.security_patch_layout);
