...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private void initScreenControllers() {
        ...
        PreferenceGroup software = (PreferenceGroup) getPreferenceScreen().findPreference("pref_screen_software");
        PreferenceGroup status = (PreferenceGroup) getPreferenceScreen().findPreference("pref_screen_status");
        PreferenceGroup other = (PreferenceGroup) getPreferenceScreen().findPreference("pref_screen_other");
