...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private void initScreenControllers() {
        ...
        PreferenceScreen software = (PreferenceScreen) getPreferenceScreen().findPreference("pref_screen_software");
        PreferenceScreen status = (PreferenceScreen) getPreferenceScreen().findPreference("pref_screen_status");
        PreferenceScreen other = (PreferenceScreen) getPreferenceScreen().findPreference("pref_screen_other");
        getPreferenceScreen().removePreference(status);
        getPreferenceScreen().removePreference(other);
        abs.setOnPositionChangeListener(new TabLayout.BaseOnTabSelectedListener() {
            @Override
