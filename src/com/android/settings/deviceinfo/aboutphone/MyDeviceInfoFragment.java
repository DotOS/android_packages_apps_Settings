...
public class MyDeviceInfoFragment extends DashboardFragment
    ...
    private void initScreenControllers() {
        ...
        PreferenceGroup software = (PreferenceGroup) pref.findPreference("pref_screen_software");
        PreferenceGroup status = (PreferenceGroup) pref.findPreference("pref_screen_status");
        PreferenceGroup other = (PreferenceGroup) pref.findPreference("pref_screen_other");
