...
public class TabLayout extends HorizontalScrollView {
    ...
    public TabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = ThemeEnforcement.obtainStyledAttributes(context, attrs, styleable.TabLayout, defStyleAttr, style.Widget_Design_TabLayout, new int[]{R.style.MaterialTabComponent});
        ...
        TypedArray ta = context.obtainStyledAttributes(this.tabTextAppearance, styleable.TextAppearance);

        try {
            this.tabTextSize = (float)ta.getDimensionPixelSize(styleable.TextAppearance_android_textSize, 0);
            this.tabTextColors = MaterialResources.getColorStateList(context, ta, styleable.TextAppearance_android_textColor);
        } finally {
            ta.recycle();
        }
